package id.technicaltest.core.data

import id.technicaltest.core.data.source.local.LocalDataSource
import id.technicaltest.core.data.source.local.entity.ShowEntity
import id.technicaltest.core.data.source.remote.ApiResponse
import id.technicaltest.core.data.source.remote.RemoteDataSource
import id.technicaltest.core.data.source.remote.response.MovieResponse
import id.technicaltest.core.data.source.remote.response.SeriesResponse
import id.technicaltest.core.domain.model.Show
import id.technicaltest.core.domain.repository.IShowRepository
